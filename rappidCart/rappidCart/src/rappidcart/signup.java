...
public class signup extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        gmail_1 = new javax.swing.JTextField();
        ...
        gmail_1.setBackground(new java.awt.Color(204, 204, 204));
        gmail_1.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        gmail_1.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        gmail_1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                gmail_1ActionPerformed(evt);
            }
        });
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                ...
                                .addGroup(jPanel2Layout.createSequentialGroup()
                                    ...
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addComponent(gmail_1, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(gmail_1, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel7))
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void proceed_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_proceed_ActionPerformed
        if(firstName_.getText().isEmpty() || lastName_.getText().isEmpty() || year_.getText().isEmpty() || userName_.getText().isEmpty() || gmail_1.getText().isEmpty() || password_.getText().isEmpty()){
            new unsuccessfull_window().control_unsuccessful_popUp_window_proceed();
        }
        
        else{
            database db = new database();
            db.set_data_to_database_from_signUpPage(first_name, last_name, user_name, day, month, year, gmail, password);

            new successfull_window().control_successful_popUp_window_signUp();
    ...
    private void cancel_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cancel_ActionPerformed
        ...
        new unsuccessfull_window().control_Unsuccessful_popUp_window_signUp_forgotPassword();
    ...
    private void gmail_1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_gmail_1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_gmail_1ActionPerformed
...
//    }
    ...
    private javax.swing.JTextField gmail_1;
